...
class IdentificationsControllerTest < ActionController::TestCase
  ...
  test "should create identification" do
    assert_difference('Identification.count') do
      post :create, identification: { password: @identification.password, token: @identification.token, userName: @identification.userName }
    end
  ...
  test "should update identification" do
    put :update, id: @identification, identification: { password: @identification.password, token: @identification.token, userName: @identification.userName }
    assert_redirected_to identification_path(assigns(:identification))
  end
